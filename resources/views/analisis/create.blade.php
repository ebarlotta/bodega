            ...
            <form action="{{ route('analisis.store') }}" method="POST">
                <div class="card shadow-lg mt-3 col-12 flex-row" style="background-color: rgb(190, 190, 190);">
                    ...
                    <div class="card-body justify-left w-2/4">
                        <p class="mb-2">Fecha: <input name="Fecha" type="date" class="rounded-md pl-2">
                        @if ($errors->get('Fecha'))
                            <span class="text-danger"> {{ $errors->first('Fecha') }} </span>
                        @endif</p>
                        <p class="mb-2">Azucar: <input name="Az" class="rounded-md pl-2"></p>
                        @if ($errors->get('Az'))
                            <span class="text-danger"> {{ $errors->first('Az') }} </span>
                        @endif</p>
                        <p class="mb-2">Alcohól: <input name="Alc" class="rounded-md pl-2"></p>
                        @if ($errors->get('Alc'))
                            <span class="text-danger"> {{ $errors->first('Alc') }} </span>
                        @endif</p>
                        <p class="mb-2">PH: <input name="Ph" class="rounded-md pl-2"></p>
                        @if ($errors->get('Ph'))
                            <span class="text-danger"> {{ $errors->first('Ph') }} </span>
                        @endif</p>
                        <p class="mb-2">Acidez Total: <input name="AcTot" class="rounded-md pl-2"></p>
                        @if ($errors->get('AcTot'))
                            <span class="text-danger"> {{ $errors->first('AcTot') }} </span>
                        @endif</p>
                        <p class="mb-2">Acidez Volátil: <input name="AcVol" class="rounded-md pl-2"></p>
                        @if ($errors->get('AcVol'))
                            <span class="text-danger"> {{ $errors->first('AcVol') }} </span>
                        @endif</p>
                        <p class="mb-2">SO Libre: <input name="SOLibre" class="rounded-md pl-2"></p>
                        @if ($errors->get('SOLibre'))
                            <span class="text-danger"> {{ $errors->first('SOLibre') }} </span>
                        @endif</p>
                        <p class="mb-2">SO Total: <input name="SOTotal" class="rounded-md pl-2"></p>
                        @if ($errors->get('SOTotal'))
                            <span class="text-danger"> {{ $errors->first('SOTotal') }} </span>
                        @endif</p>
                        <p class="mb-2">Color: <input name="Color" class="rounded-md pl-2"></p>
                        @if ($errors->get('Color'))
                            <span class="text-danger"> {{ $errors->first('Color') }} </span>
                        @endif</p>
                        <p class="mb-2">LC: <input name="LC" class="rounded-md pl-2"></p>
                        @if ($errors->get('LC'))
                            <span class="text-danger"> {{ $errors->first('LC') }} </span>
                        @endif</p>
                        <p class="mb-2">Matiz: <input name="Matiz" class="rounded-md pl-2"></p>
                        @if ($errors->get('Matiz'))
